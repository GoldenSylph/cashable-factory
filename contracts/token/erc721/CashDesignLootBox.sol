 ...
 *
 * CashDesignLootBox - a tradeable loot box of Cash Designs.
 */
contract CashDesignLootBox is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, address _factoryAddress)
        public
        ERC721Tradable("CashDesignLootBox", "CHDNLootbox", _proxyRegistryAddress)
    {
